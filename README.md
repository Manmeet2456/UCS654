...
- \( a_r = 0.5 (r \mod 7) \)
- \( b_r = 0.3 ((r \mod 5) + 1) \)
- \( r \) is my university roll number,i.e, 102317039
...
The histogram of generated samples overlaps well with the histogram of real transformed data, indicating that the GAN learned the overall shape of the distribution.

<img width="584" height="455" alt="download" src="https://github.com/user-attachments/assets/a055749e-54c6-44bf-b178-a046889abf72" />
